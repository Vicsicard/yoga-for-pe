  ...
  return (
    <section className="py-16 bg-white">
      <div className="container">
        <h2 className="text-3xl font-bold text-center mb-4">Bend, Brighten, Bloom: Yoga for PE & Everybody
        <p className="text-center text-lg text-gray-600 mb-12 max-w-3xl mx-auto">Bend the body, brighten the mind, and bloom the soul
