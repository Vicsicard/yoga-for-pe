...
const benefits = [
  ...
  },
  {
    ...
    standardsAlignment: 'Aligns with Standard 1: Demonstrates competency in a variety of motor skills and movement patterns. Yoga develops motor skills like balance, coordination, and controlled movement, helping students become more physically literate and confident movers.',
    icon: FiActivity
  },
  {
    id: 4,
  ...
  },
  {
    ...
    standardsAlignment: 'Aligns with Standard 4: Exhibits responsible personal and social behavior that respects self and others. A yoga environment fosters mindfulness, respect, and calm. By making yoga inclusive through adaptations, students also learn respect for individual differences and promote a positive class culture.',
    icon: FiUsers
  },
  {
    id: 6,
