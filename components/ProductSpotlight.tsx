      ...
      <div className="container">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-1">
            <div className="aspect-w-16 aspect-h-9 mb-4 rounded-lg overflow-hidden shadow-lg bg-gradient-to-r from-primary-500 to-secondary-500">
              <div className="flex items-center justify-center w-full h-64 text-white">
                <span className="text-xl font-medium">Curriculum Preview Image</span>
              </div>
            </div>
          ...
          <div className="order-1 md:order-2">
            ...
            <h2 className="text-3xl font-bold mb-4">Comprehensive Yoga Curriculum</h2>
            
            <div className="flex items-center mb-6">
              <span className="text-2xl font-bold text-primary-600 mr-3">$165.00</span>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="border border-gray-200 rounded-lg p-3 text-center">
                ...
                <span className="font-semibold">8-18 years</span>
              </div>
              <div className="border border-gray-200 rounded-lg p-3 text-center">
                <span className="block text-xs text-gray-500 mb-1">Resources</span>
                <span className="font-semibold">Digital + Print</span>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start">
                  ...
                  <span>16-week progressive curriculum</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2">✓</span>
                  <span>45 instructional videos</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2">✓</span>
                  <span>Printable pose guides and worksheets</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2">✓</span>
