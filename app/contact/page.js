  ...
  return (
    <main>
      ...
      <HeroSlider height="h-[400px] md:h-[500px]" overlayOpacity="medium" autoplayInterval={6000} pageType="contact">
        <HeroSliderContent>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 drop-shadow-md">Get in Touch
        ...
        <Container>
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-1">
              <h2 className="text-2xl font-bold mb-6">Contact Information
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium">Email
                    <p className="text-gray-600">hello@yogaforpe.com
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium">Phone
                    <p className="text-gray-600">720.514.9820
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium">Location
                    <p className="text-gray-600">Colorado (Available for worldwide travel)</p>
                    <p className="text-gray-600 mt-1">Wholistic Mechanics, INC
                  </div>
                </div>
              </div>

              <div className="mt-10">
                <h3 className="text-xl font-bold mb-4">Professional Development Options
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <div className="h-2 w-2 rounded-full bg-primary-500 mr-2"></div>
                    <span>In-services for schools and districts
                  </li>
                  <li className="flex items-center">
                    <div className="h-2 w-2 rounded-full bg-primary-500 mr-2"></div>
                    <span>Guest speaking at conferences
                  </li>
                  <li className="flex items-center">
                    <div className="h-2 w-2 rounded-full bg-primary-500 mr-2"></div>
                    <span>Custom curriculum design
                  </li>
                  <li className="flex items-center">
                    <div className="h-2 w-2 rounded-full bg-primary-500 mr-2"></div>
                    <span>One-on-one consulting
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="md:col-span-2">
              <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-100">
                <h2 className="text-2xl font-bold mb-6">Send Us a Message
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="curriculum">Curriculum Questions
                      <option value="videos">Video Content Access
                      <option value="speaking">Speaking Engagement
                    </select>
                  </div>
