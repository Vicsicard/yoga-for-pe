      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-primary-800 to-primary-900 text-white py-12">
          <div className="container">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Yoga Travel Adventures</h1>
          ...
          <>
            ...
            {featuredStories.length > 0 && (
              <section className="py-12 bg-gray-50">
                <div className="container">
                  <h2 className="text-2xl font-bold mb-8">Featured Adventures</h2>
                        ...
                        <div className="p-6 flex-grow">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center text-sm text-gray-500">
                              ...
                              <span>{story.imageCount} photos</span>
                            </div>
                          </div>
                        </div>
        ...
        {activeTab === 'upcoming' && (
          <section className="py-12 bg-gray-50">
            <div className="container">
              <h2 className="text-2xl font-bold mb-8">Upcoming Travel Opportunities</h2>
              ...
              <div className="bg-white p-6 md:p-8 rounded-xl shadow-md mb-8">
                <div className="prose max-w-none">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li><strong>Teacher Retreats</strong> - Rejuvenating experiences focused on self-care and professional development</li>
                    <li><strong>Educational Tours</strong> - Visit schools and programs implementing yoga in different cultural contexts</li>
                    <li><strong>Conference Travel</strong> - Join us at international PE and yoga education conferences</li>
                    <li><strong>Service Trips</strong> - Volunteer to teach yoga in underserved communities worldwide</li>
                  </ul>
                </div>
              </div>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="md:flex">
                    ...
                    <div className="p-6 md:w-2/3">
                      ...
                      <h3 className="text-xl font-bold mb-2">Mindfulness in Japanese Education: A Study Tour</h3>
                      <div className="flex items-center text-sm text-gray-500 mb-3">
                        <FiMapPin className="mr-1" />
                        <span>Tokyo, Kyoto, and Okinawa, Japan</span>
                        <span className="mx-2">•</span>
                        <FiCalendar className="mr-1" />
                        <span>June 10-24, 2025</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-gray-700 font-bold">
                          $3,850 <span className="text-sm font-normal text-gray-500">per person</span>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="md:flex">
                    ...
                    <div className="p-6 md:w-2/3">
                      ...
                      <h3 className="text-xl font-bold mb-2">Greek Islands Yoga Retreat for PE Teachers</h3>
                      <div className="flex items-center text-sm text-gray-500 mb-3">
                        <FiMapPin className="mr-1" />
                        <span>Crete and Santorini, Greece</span>
                        <span className="mx-2">•</span>
                        <FiCalendar className="mr-1" />
                        <span>August 5-15, 2025</span>
                      </div>
                      <p className="text-gray-600 mb-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-gray-700 font-bold">
                          $2,995 <span className="text-sm font-normal text-gray-500">per person</span>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="md:flex">
                    <div className="md:w-1/3 h-48 md:h-auto bg-gray-300 relative">
                      {/* This would be the trip image */}
                      <div className="absolute inset-0 flex items-center justify-center text-white">
                        <span>Costa Rica Trip Image</span>
                      </div>
                    </div>
                    <div className="p-6 md:w-2/3">
                      <div className="flex flex-wrap gap-2 mb-3">
                      ...
                      <h3 className="text-xl font-bold mb-2">Costa Rica Service Learning: Yoga in Rural Schools</h3>
                      <div className="flex items-center text-sm text-gray-500 mb-3">
                        <FiMapPin className="mr-1" />
                        <span>San José and Monteverde, Costa Rica</span>
                        <span className="mx-2">•</span>
                        <FiCalendar className="mr-1" />
                        <span>November 8-18, 2025</span>
                      </div>
                      <p className="text-gray-600 mb-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-gray-700 font-bold">
                          $2,250 <span className="text-sm font-normal text-gray-500">per person</span>
                        </div>
