...
const benefits = [
  ...
  },
  {
    ...
    standardsAlignment: 'Aligns with Standard 1, and controlled movement.',
    icon="w-full h-full p-2" />
  },
  {
    id,
  ...
  },
  {
    ...
    standardsAlignment: 'Aligns with Standard 4, and calm.',
    icon="w-full h-full p-2" />
  },
  {
    id,
    ...
    <main>
      ...
      <Section spacing="xl">
        ...
        <div className="mt-16 bg-white p-8 rounded-lg shadow-sm">
          <h3 className="text-2xl font-bold text-center mb-4">Contact Yoga For PE and Everybody
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
            <div className="p-4 bg-white rounded shadow-sm hover:shadow-md transition-shadow">
              <h4 className="font-medium mb-2">In-services
              <p className="text-sm text-gray-600">Specialized training for your school or district
            </div>
            <div className="p-4 bg-white rounded shadow-sm hover:shadow-md transition-shadow">
              <h4 className="font-medium mb-2">Guest Speaking
              <p className="text-sm text-gray-600">Engaging presentations for professional events
            </div>
            <div className="p-4 bg-white rounded shadow-sm hover:shadow-md transition-shadow">
              <h4 className="font-medium mb-2">Curriculum Design
              <p className="text-sm text-gray-600">Custom curriculum development for your specific needs
            </div>
            <div className="p-4 bg-white rounded shadow-sm hover:shadow-md transition-shadow">
              <h4 className="font-medium mb-2">One-on-One Consulting
              <p className="text-sm text-gray-600">Personalized coaching for educators
            </div>
          </div>
