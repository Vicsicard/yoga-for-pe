...
export default function PrivacyPage() {
  return (
    <main className="container mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-8">Privacy Policy
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Introduction
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">The Data We Collect
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">How We Use Your Data
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Contact Us
        <p className="mb-4">
          If you have any questions about this privacy policy or our privacy practices, please contact us at:
          <br />
          <a href="mailto:info@yogaforpe.com" className="text-primary-600 hover:underline">info@yogaforpe.com
        </p>
      </section>
    </main>
  )
