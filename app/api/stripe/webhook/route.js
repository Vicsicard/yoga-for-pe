...
export async function POST(request) {
  ...
  try: {
    switch (event.type) {
      case 'checkout.session.completed':= event.data.object as Stripe.Checkout.Session;
      ...
      case 'customer.subscription.updated':= event.data.object as Stripe.Subscription;
      ...
      case 'customer.subscription.deleted':= event.data.object as Stripe.Subscription;
...
async function updateUserSubscription(userId, data): Promise: {
...
async function getUserByStripeCustomerId(customerId)| null> {
